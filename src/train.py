...
from transformers import (
    AutoTokenizer, AutoModelForSequenceClassification, Trainer, TrainingArguments, set_seed
)
...
def main():
    ...
    def tokenize(batch):
        return tokenizer(batch['fact'], padding='max_length', truncation=True)
